...
export default function Home() {
  return (
    <div className="flex flex-col-reverse md:flex-row items-center justify-between min-h-[75vh] gap-12 py-12">
      ...
      >
        ...
        <div className="flex flex-col sm:flex-row w-full sm:w-auto gap-4 mb-12">
          ...
          <a 
            ...
            className="w-full sm:w-auto bg-slate-900 dark:bg-white text-white dark:text-slate-900 px-8 py-3 rounded-md hover:bg-slate-800 dark:hover:bg-slate-100 transition-colors flex items-center justify-center gap-2 font-medium"
          >
            View Drive Portfolio <ArrowRight size={18} />
          </a>
          <Link 
            to="/contact" 
            className="w-full sm:w-auto bg-white dark:bg-slate-900 text-slate-900 dark:text-slate-100 border border-slate-300 dark:border-slate-800 px-8 py-3 rounded-md hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors font-medium text-center"
          >
            Get in Touch
          </Link>
        </div>
      ...
      >
        <div className="aspect-square rounded-3xl bg-slate-100 dark:bg-slate-900 border-8 border-white dark:border-slate-900 shadow-xl dark:shadow-indigo-500/5 overflow-hidden relative transition-colors duration-300">
           {/* 
